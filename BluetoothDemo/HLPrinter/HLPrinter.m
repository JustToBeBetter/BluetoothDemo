...
{
    [self appendQRCodeWithInfo:info size:size alignment:HLTextAlignmentRight];
}
...
{
    [self appendQRCodeWithInfo:info centerImage:nil alignment:HLTextAlignmentRight maxWidth:250];
}
